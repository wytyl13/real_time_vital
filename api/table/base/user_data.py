...
from sqlalchemy import Column, Integer, String, DateTime, Boolean, BigInteger, Text, SmallInteger, Float
...
class UserData(Base):
    ...
    phone = Column(String(20), nullable=False, unique=False, comment='手机号')
